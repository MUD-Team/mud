...
#define EDGE_DEFAULT_KEY_USE         (kSpace + (kGamepadSouth << 16))
...
#define EDGE_DEFAULT_KEY_RELOAD     ('r' + (kGamepadWest << 16))
...
#define EDGE_DEFAULT_KEY_ACTION1    ('o' + (kGamepadNorth << 16))
#define EDGE_DEFAULT_KEY_ACTION2    ('p' + (kGamepadEast << 16))
