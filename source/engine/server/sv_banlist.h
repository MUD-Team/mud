...
//-----------------------------------------------------------------------------
//
// $Id: 6096f73fc588587c2b63f280f524dbeb193b29b9 $
//
...
class Banlist
{
  public:
    size_t size();
    bool   add(const std::string &address, const time_t expire = 0, const std::string &name = std::string(),
               const std::string &reason = std::string());
    bool   add(player_t &player, const time_t expire = 0, const std::string &reason = std::string());
    bool   add_exception(const std::string &address, const std::string &name = std::string());
    ...
    bool   query_exception(const std::string &query, exceptionlist_results_t &result);
