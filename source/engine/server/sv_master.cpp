...
//-----------------------------------------------------------------------------
//
// $Id: f7b89e4feb1bc594f73717ea94f9719ac7606d3e $
//
...
class masterserver
{
  public:
    ...
    masterserver(const masterserver &other) : masterip(other.masterip), masteraddr(other.masteraddr)
    {
    }
...
VERSION_CONTROL(sv_master_cpp, "$Id: f7b89e4feb1bc594f73717ea94f9719ac7606d3e $")
