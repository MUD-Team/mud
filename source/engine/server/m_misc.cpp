...
void STACK_ARGS M_SaveDefaults()
{
    ...
    if ((f = PHYSFS_openWrite("odasrv.cfg")))
    {
        std::string str = StrFormat("// Generated by Odasrv " DOTVERSIONSTR "\n\n");
        ...
        Printf(PRINT_HIGH, "Configuration saved to odasrv.cfg.\n");
    }
}
...
{
    std::string cmd = "exec " + C_QuoteString("odasrv.cfg");
