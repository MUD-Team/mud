...
//-----------------------------------------------------------------------------
//
// $Id: 06f9b0ce21c28c2a3ca46a04ddd04de6184c7298 $
//
...
#define CEIL_SLOW   8
#define CEIL_NORMAL 16
#define CEIL_FAST   32
#define CEIL_TURBO  64

#define CEILWAIT 150

// Speeds for floors (x/8 units per tic)
#define FLOOR_SLOW   8
#define FLOOR_NORMAL 16
#define FLOOR_FAST   32
#define FLOOR_TURBO  64

// Speeds for doors (x/8 units per tic)
#define DOOR_SLOW   16
#define DOOR_NORMAL 32
#define DOOR_FAST   64
#define DOOR_TURBO  128

#define VDOORWAIT  150
#define VDOORSPEED (FRACUNIT * 2)

// Speeds for stairs (x/8 units per tic)
#define STAIRS_SLOW   2
#define STAIRS_NORMAL 4
#define STAIRS_FAST   16
#define STAIRS_TURBO  32

// Speeds for plats (Hexen plats stop 8 units above the floor)
#define PLAT_SLOW   8
#define PLAT_NORMAL 16
#define PLAT_FAST   32
#define PLAT_TURBO  64
