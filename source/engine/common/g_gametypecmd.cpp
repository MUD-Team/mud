 ...
 */
template <size_t SIZE> static StringList GametypeArgs(const GametypeParam (&params)[SIZE], size_t argc, char **argv)
{
    StringList ret;
...
static GametypeParam coopParams[] = {
    {"sv_skill", 4, "skill", "SKILL", "Set the skill of the game to SKILL.  Defaults to 4."}};
...
static GametypeParam survivalParams[] = {
    {"g_lives", 3, "lives", "LIVES", "Set number of player lives to LIVES.  Defaults to 3."},
    {"sv_skill", 4, "skill", "SKILL", "Set the skill of the game to SKILL.  Defaults to 4."}};
...
static GametypeParam dmParams[] = {
    {"sv_fraglimit", 30, "frags", "FRAGLIMIT", "Set number of frags needed to win to FRAGLIMIT.  Defaults to 30."},
...
static GametypeParam duelParams[] = {
    {"sv_fraglimit", 50, "frags", "FRAGLIMIT", "Set number of frags needed to win to FRAGLIMIT.  Defaults to 50."}};
...
static GametypeParam lmsParams[] = {
    {"g_lives", 1, "lives", "LIVES", "Set number of player lives per round to LIVES.  Defaults to 1."},
    {"g_winlimit", 5, "wins", "WINS", "Set number of round wins needed to win the game to WINS.  Defaults to 5."}};

static void LMSHelp()
{
    Printf("game_lms - Configures some settings for a basic game of Last Marine Standing\n");
...
static GametypeParam tdmParams[] = {
    {"sv_fraglimit", 50, "frags", "FRAGLIMIT", "Set number of frags needed to win to FRAGLIMIT.  Defaults to 30."},
    {"sv_timelimit", 10, "time", "TIMELIMIT",
     "Set number of minutes until the match ends to TIMELIMIT.  Defaults to 10."}};
...
static GametypeParam tlmsParams[] = {
    {"g_lives", 1, "lives", "LIVES", "Set number of player lives per round to LIVES.  Defaults to 1."},
    {"sv_teamsinplay", 2, "teams", "TEAMS", "Set number of teams in play to TEAMS.  Defaults to 2."},
    {"g_winlimit", 5, "wins", "WINS", "Set number of round wins needed to win the game to WINS.  Defaults to 5."}};
...
static GametypeParam ctfParams[] = {
    {"sv_scorelimit", 5, "score", "SCORELIMIT", "Set number of scores needed to win to SCORELIMIT.  Defaults to 5."},
    {"sv_teamsinplay", 2, "teams", "TEAMS", "Set number of teams in play to TEAMS.  Defaults to 2."},
    {"sv_timelimit", 10, "time", "TIMELIMIT",
     "Set number of minutes until the match ends to TIMELIMIT.  Defaults to 10."}};
...
static GametypeParam hordeParams[] = {
    {"sv_skill", 4, "skill", "SKILL", "Set the skill of the game to SKILL.  Defaults to 4."},
    {"g_lives", 1, "lives", "LIVES", "Set number of scores needed to win to LIVES.  Defaults to 5."},
    {"g_roundlimit", 2, "rounds", "ROUNDS", "Set number of second-chance rounds there are to ROUNDS.  Defaults to 2."}};
