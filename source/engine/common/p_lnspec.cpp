...
//-----------------------------------------------------------------------------
//
// $Id: 6d848d57dd7a275422a95b1c35cc2b1bf502a8d9 $
//
...
{
    return EV_DoZDoomDoor(DDoor::doorClose, ln, it, arg0, arg1, 0, zk_none, arg2, false, 0);
}

FUNC(LS_Door_Open)
// Door_Open (tag, speed)
{
    return EV_DoZDoomDoor(DDoor::doorOpen, ln, it, arg0, arg1, 0, zk_none, arg2, false, 0);
}

FUNC(LS_Door_Raise)
// Door_Raise (tag, speed, delay)
{
    return EV_DoZDoomDoor(DDoor::doorRaise, ln, it, arg0, arg1, arg2, zk_none, arg3, false, 0);
}

FUNC(LS_Door_LockedRaise)
// Door_LockedRaise (tag, speed, delay, lock)
{
    return EV_DoZDoomDoor(arg2 ? DDoor::doorRaise : DDoor::doorOpen, ln, it, arg0, arg1, arg2, (zdoom_lock_t)arg3, arg4,
                          false, 0);
}
...
{
    return EV_DoZDoomDoor(DDoor::genCdO, ln, it, arg0, arg1, (int)arg2 * 35 / 8, zk_none, arg3, false, 0);
}

FUNC(LS_Door_WaitRaise)
// Door_WaitRaise (tag, speed, delay, wait, lighttag)
{
    return EV_DoZDoomDoor(DDoor::waitRaiseDoor, ln, it, arg0, arg1, arg2, zk_none, arg4, false, arg3);
}

FUNC(LS_Door_WaitClose)
// Door_WaitClose (tag, speed, wait, lighttag)
{
    return EV_DoZDoomDoor(DDoor::waitCloseDoor, ln, it, arg0, arg1, 0, zk_none, arg3, false, arg2);
}
...
// Generic_Door (tag, speed, kind, delay, lock)
{
    ...
    return EV_DoZDoomDoor(type, ln, it, tag, arg1, (int)arg3 * 35 / 8, (zdoom_lock_t)arg4, lightTag, boomgen, 0);
}
...
{
    return EV_DoZDoomFloor(DFloor::floorLowerByValue, ln, arg0, P_ArgToSpeed(arg1), arg2, NO_CRUSH, P_ArgToChange(arg3),
                           false, false);
}
...
{
    return EV_DoZDoomFloor(DFloor::floorLowerToLowest, ln, arg0, P_ArgToSpeed(arg1), 0, NO_CRUSH, P_ArgToChange(arg2),
                           false, false);
}
...
{
    return EV_DoZDoomFloor(DFloor::floorLowerToLowestCeiling, ln, arg0, P_ArgToSpeed(arg1), 0, NO_CRUSH,
                           P_ArgToChange(arg2), false, false);
}

FUNC(LS_Floor_LowerToHighest)
// Floor_LowerToHighest (tag, speed, adjust)
{
    return EV_DoZDoomFloor(DFloor::floorLowerToHighest, ln, arg0, P_ArgToSpeed(arg1), (int)arg2 - 128, NO_CRUSH, 0,
                           false, arg3 == 1);
}
...
{
    return EV_DoZDoomFloor(DFloor::floorLowerToHighest, ln, arg0, P_ArgToSpeed(arg1), 0, NO_CRUSH, P_ArgToChange(arg2),
                           false, false);
}
...
{
    return EV_DoZDoomFloor(DFloor::floorLowerToNearest, ln, arg0, P_ArgToSpeed(arg1), 0, NO_CRUSH, P_ArgToChange(arg2),
                           false, false);
}
...
{
    return EV_DoZDoomFloor(DFloor::floorRaiseByValue, ln, arg0, P_ArgToSpeed(arg1), arg2, P_ArgToCrush(arg4),
...
{
    return EV_DoZDoomFloor(DFloor::floorRaiseToHighest, ln, arg0, P_ArgToSpeed(arg1), 0, P_ArgToCrush(arg3),
                           P_ArgToChange(arg2), true, false);
}

FUNC(LS_Floor_RaiseToNearest)
// Floor_RaiseToNearest (tag, speed)
{
    return EV_DoZDoomFloor(DFloor::floorRaiseToNearest, ln, arg0, P_ArgToSpeed(arg1), 0, P_ArgToCrush(arg3),
                           P_ArgToChange(arg2), true, false);
}
...
{
    return EV_DoZDoomFloor(DFloor::floorRaiseAndCrush, ln, arg0, P_ArgToSpeed(arg1), 0, arg2, 0, P_ArgToCrushType(arg3),
                           false);
}
...
{
    return EV_DoZDoomFloor(DFloor::floorRaiseAndCrushDoom, ln, arg0, P_ArgToSpeed(arg1), 0, arg2, 0,
                           P_ArgToCrushType(arg3), false);
}

FUNC(LS_Floor_RaiseByValueTimes8)
// FLoor_RaiseByValueTimes8 (tag, speed, height)
{
    return EV_DoZDoomFloor(DFloor::floorRaiseByValue, ln, arg0, P_ArgToSpeed(arg1), (int)arg2 * 8, P_ArgToCrush(arg4),
                           P_ArgToChange(arg3), true, false);
}
...
{
    return EV_DoZDoomFloor(DFloor::floorLowerByValue, ln, arg0, P_ArgToSpeed(arg1), (int)arg2 * 8, NO_CRUSH,
                           P_ArgToChange(arg3), false, false);
}
...
{
    return EV_DoZDoomFloor(DFloor::floorLowerInstant, ln, arg0, 0, (int)arg2 * 8, NO_CRUSH, P_ArgToChange(arg3), false,
                           false);
}
...
{
    return EV_DoZDoomFloor(DFloor::floorRaiseInstant, ln, arg0, 0, (int)arg2 * 8, P_ArgToCrush(arg4),
                           P_ArgToChange(arg3), true, false);
}
...
{
    return EV_DoZDoomFloor(DFloor::floorMoveToValue, ln, arg0, P_ArgToSpeed(arg1), (int)arg2 * (arg3 ? -1 : 1),
                           NO_CRUSH, P_ArgToChange(arg4), false, false);
}

FUNC(LS_Floor_MoveToValueTimes8)
// Floor_MoveToValueTimes8 (tag, speed, height, negative)
{
    return EV_DoZDoomFloor(DFloor::floorMoveToValue, ln, arg0, P_ArgToSpeed(arg1), (int)arg2 * 8 * (arg3 ? -1 : 1),
                           NO_CRUSH, P_ArgToChange(arg4), false, false);
}
...
{
    return EV_DoZDoomFloor(DFloor::floorRaiseToLowest, ln, arg0, 2, 0, P_ArgToCrush(arg3), P_ArgToChange(arg2), true,
                           false);
}
...
{
    return EV_DoZDoomFloor(DFloor::floorRaiseToLowestCeiling, ln, arg0, 2, 0, P_ArgToCrush(arg3), P_ArgToChange(arg2),
                           true, false);
}
...
{
    return EV_DoZDoomFloor(DFloor::floorRaiseToLowestCeiling, ln, arg0, P_ArgToSpeed(arg1), 0, P_ArgToCrush(arg3),
                           P_ArgToChange(arg2), true, false);
}
...
{
    return EV_DoZDoomFloor(DFloor::floorRaiseToCeiling, ln, arg0, P_ArgToSpeed(arg1), arg4, P_ArgToCrush(arg3),
                           P_ArgToChange(arg2), true, false);
}
...
{
    return EV_DoZDoomFloor(DFloor::floorRaiseByTexture, ln, arg0, P_ArgToSpeed(arg1), 0, P_ArgToCrush(arg3),
                           P_ArgToChange(arg2), true, false);
}
...
{
    return EV_DoZDoomFloor(DFloor::floorLowerByTexture, ln, arg0, P_ArgToSpeed(arg1), 0, NO_CRUSH, P_ArgToChange(arg2),
                           true, false);
}
...
{
    return EV_DoZDoomFloor(DFloor::floorRaiseAndChange, ln, arg0, P_ArgToSpeed(arg1), arg2, NO_CRUSH, 0, false, false);
}

FUNC(LS_Floor_LowerToLowestTxTy)
// Floor_LowerToLowestTxTy (tag, speed)
{
    return EV_DoZDoomFloor(DFloor::floorLowerAndChange, ln, arg0, P_ArgToSpeed(arg1), 0, NO_CRUSH, 0, false, false);
}
...
// Generic_Floor (tag, speed, height, target, change/model/direct/crush)
{
    ...
    if (arg4 & 8)
    {
        ...
        {
        case 1:
            type = DFloor::floorRaiseToHighest;
            break;
        case 2:
            type = DFloor::floorRaiseToLowest;
            break;
        case 3:
            type = DFloor::floorRaiseToNearest;
            break;
        case 4:
            type = DFloor::floorRaiseToLowestCeiling;
            break;
        case 5:
            type = DFloor::floorRaiseToCeiling;
            break;
        case 6:
            type = DFloor::floorRaiseByTexture;
            break;
        default:
            type = DFloor::floorRaiseByValue;
            break;
        }
    }
    else
    {
        ...
        {
        case 1:
            type = DFloor::floorLowerToHighest;
            break;
        case 2:
            type = DFloor::floorLowerToLowest;
            break;
        case 3:
            type = DFloor::floorLowerToNearest;
            break;
        case 4:
            type = DFloor::floorLowerToLowestCeiling;
            break;
        case 5:
            type = DFloor::floorLowerToCeiling;
            break;
        case 6:
            type = DFloor::floorLowerByTexture;
            break;
        default:
            type = DFloor::floorLowerByValue;
            break;
        }
    }

    return EV_DoZDoomFloor(type, ln, arg0, P_ArgToSpeed(arg1), arg2, (arg4 & 16) ? 20 : NO_CRUSH, arg4 & 7, false,
                           false);
}
...
{
    return EV_BuildStairs(arg0, DFloor::buildDown, ln, arg2 * FRACUNIT, SPEED(arg1), TICS(arg3), arg4, 0, 1);
}

FUNC(LS_Stairs_BuildUp)
// Stairs_BuildUp (tag, speed, height, delay, reset)
{
    return EV_BuildStairs(arg0, DFloor::buildUp, ln, arg2 * FRACUNIT, SPEED(arg1), TICS(arg3), arg4, 0, 1);
}

FUNC(LS_Stairs_BuildDownSync)
// Stairs_BuildDownSync (tag, speed, height, reset)
{
    return EV_BuildStairs(arg0, DFloor::buildDown, ln, arg2 * FRACUNIT, SPEED(arg1), 0, arg3, 0, 2);
}

FUNC(LS_Stairs_BuildUpSync)
// Stairs_BuildUpSync (tag, speed, height, reset)
{
    return EV_BuildStairs(arg0, DFloor::buildUp, ln, arg2 * FRACUNIT, SPEED(arg1), 0, arg3, 0, 2);
}

FUNC(LS_Stairs_BuildUpDoom)
// Stairs_BuildUpDoom (tag, speed, height, delay, reset)
{
    return EV_BuildStairs(arg0, DFloor::buildUp, ln, arg2 * FRACUNIT, SPEED(arg1), arg3, arg4, 0, 0);
}

FUNC(LS_Stairs_BuildDownDoom)
// Stairs_BuildDownDoom (tag, speed, height, delay, reset)
{
    return EV_BuildStairs(arg0, DFloor::buildDown, ln, arg2 * FRACUNIT, SPEED(arg1), arg3, arg4, 0, 0);
}
...
{
    return EV_BuildStairs(arg0, DFloor::buildUp, ln, arg2 * FRACUNIT, SPEED(arg1), arg3, arg4, 0, 1);
}
...
// Pillar_Build (tag, speed, height)
{
    return EV_DoZDoomPillar(DPillar::pillarBuild, ln, arg0, P_ArgToSpeed(arg1), arg2, 0, arg3, P_ArgToCrushType(arg4));
}

FUNC(LS_Pillar_Open)
// Pillar_Open (tag, speed, f_height, c_height)
{
    return EV_DoZDoomPillar(DPillar::pillarOpen, ln, arg0, P_ArgToSpeed(arg1), arg2, arg3, NO_CRUSH, false);
}

FUNC(LS_Ceiling_LowerByValue)
// Ceiling_LowerByValue (tag, speed, height)
{
    return EV_DoZDoomCeiling(DCeiling::ceilLowerByValue, ln, arg0, P_ArgToSpeed(arg1), 0, arg2, NO_CRUSH, 0, 0,
                             crushDoom);
}
...
{
    return EV_DoZDoomCeiling(DCeiling::ceilRaiseByValue, ln, arg0, P_ArgToSpeed(arg1), 0, arg2, NO_CRUSH, 0, 0,
                             crushDoom);
}
...
{
    return EV_DoZDoomCeiling(DCeiling::ceilLowerByValue, ln, arg0, P_ArgToSpeed(arg1), 0, (int)arg2 * 8, NO_CRUSH, 0, 0,
                             crushDoom);
}
...
{
    return EV_DoZDoomCeiling(DCeiling::ceilRaiseByValue, ln, arg0, P_ArgToSpeed(arg1), 0, (int)arg2 * 8, NO_CRUSH, 0, 0,
                             crushDoom);
}
...
{
    return EV_DoZDoomCeiling(DCeiling::ceilCrushAndRaise, ln, arg0, P_ArgToSpeed(arg1), P_ArgToSpeed(arg1) / 2, 8, arg2,
...
{
    return EV_DoZDoomCeiling(DCeiling::ceilCrushAndRaise, ln, arg0, P_ArgToSpeed(arg2), P_ArgToSpeed(arg2), arg1, arg3,
                             0, 0, (crushmode_e)P_ArgToCrushMode(arg4, arg2 == 8));
}

FUNC(LS_Ceiling_LowerAndCrush)
// Ceiling_LowerAndCrush (tag, speed, crush [, crushmode])
{
    return EV_DoZDoomCeiling(DCeiling::ceilLowerAndCrush, ln, arg0, P_ArgToSpeed(arg1), P_ArgToSpeed(arg1), 8, arg2, 0,
...
{
    return EV_DoZDoomCeiling(DCeiling::ceilLowerAndCrush, ln, arg0, P_ArgToSpeed(arg1), P_ArgToSpeed(arg1), arg3, arg2,
                             0, 0, (crushmode_e)P_ArgToCrushMode(arg4, arg1 == 8));
}
...
{
    return EV_DoZDoomCeiling(DCeiling::ceilCrushRaiseAndStay, ln, arg0, P_ArgToSpeed(arg1), P_ArgToSpeed(arg1) / 2, 8,
                             arg2, 0, 0, (crushmode_e)P_ArgToCrushMode(arg3, false));
}
...
// Ceiling_MoveToValueTimes8 (tag, speed, height, negative)
{
    return EV_DoZDoomCeiling(DCeiling::ceilMoveToValue, ln, arg0, P_ArgToSpeed(arg1), 0,
                             (int)arg2 * 8 * (arg3 ? -1 : 1), NO_CRUSH, 0, 0, crushDoom);
}

FUNC(LS_Ceiling_MoveToValue)
// Ceiling_MoveToValue (tag, speed, height, negative)
{
    return EV_DoZDoomCeiling(DCeiling::ceilMoveToValue, ln, arg0, P_ArgToSpeed(arg1), 0, (int)arg2 * (arg3 ? -1 : 1),
...
{
    return EV_DoZDoomCeiling(DCeiling::ceilLowerToHighestFloor, ln, arg0, P_ArgToSpeed(arg1), 0, arg4, NO_CRUSH, 0, 0,
                             crushDoom);
}
...
{
    return EV_DoZDoomCeiling(DCeiling::ceilLowerInstant, ln, arg0, 0, 0, (int)arg2 * 8, NO_CRUSH, 0, 0, crushDoom);
}

FUNC(LS_Ceiling_RaiseInstant)
// Ceiling_RaiseInstant (tag, unused, height)
{
    return EV_DoZDoomCeiling(DCeiling::ceilRaiseInstant, ln, arg0, 0, 0, (int)arg2 * 8, NO_CRUSH, 0, 0, crushDoom);
}

FUNC(LS_Ceiling_CrushRaiseAndStayA)
// Ceiling_CrushRaiseAndStayA (tag, dnspeed, upspeed, damage[, crushmode])
{
    return EV_DoZDoomCeiling(DCeiling::ceilCrushRaiseAndStay, ln, arg0, P_ArgToSpeed(arg1), P_ArgToSpeed(arg2), 0, arg3,
                             0, 0, (crushmode_e)P_ArgToCrushMode(arg4, false));
}
...
{
    return EV_DoZDoomCeiling(DCeiling::ceilCrushRaiseAndStay, ln, arg0, P_ArgToSpeed(arg1), P_ArgToSpeed(arg2), 0, arg3,
                             1, 0, (crushmode_e)P_ArgToCrushMode(arg4, false));
}

FUNC(LS_Ceiling_CrushAndRaiseA)
// Ceiling_CrushAndRaiseA (tag, dnspeed, upspeed, damage[, crushmode])
{
    return EV_DoZDoomCeiling(DCeiling::ceilCrushAndRaise, ln, arg0, P_ArgToSpeed(arg1), P_ArgToSpeed(arg2), 0, arg3, 0,
                             0, (crushmode_e)P_ArgToCrushMode(arg4, arg1 == 8 && arg2 == 8));
}

FUNC(LS_Ceiling_CrushAndRaiseSilentA)
// Ceiling_CrushAndRaiseSilentA (tag, dnspeed, upspeed, damage[, crushmode])
{
    return EV_DoZDoomCeiling(DCeiling::ceilCrushAndRaise, ln, arg0, P_ArgToSpeed(arg1), P_ArgToSpeed(arg2), 0, arg3, 1,
                             0, (crushmode_e)P_ArgToCrushMode(arg4, arg1 == 8 && arg2 == 8));
}
...
{
    return EV_DoZDoomCeiling(DCeiling::ceilRaiseToNearest, ln, arg0, P_ArgToSpeed(arg1), 0, 0, NO_CRUSH, 0, 0,
                             crushDoom);
}
...
{
    return EV_DoZDoomCeiling(DCeiling::ceilRaiseToHighest, ln, arg0, P_ArgToSpeed(arg1), 0, 0, NO_CRUSH, 0,
...
{
    return EV_DoZDoomCeiling(DCeiling::ceilRaiseToHighestFloor, ln, arg0, P_ArgToSpeed(arg1), 0, 0, NO_CRUSH, 0,
                             P_ArgToChange(arg2), crushDoom);
}
...
{
    return EV_DoZDoomCeiling(DCeiling::ceilRaiseToLowest, ln, arg0, P_ArgToSpeed(arg1), 0, 0, NO_CRUSH, 0,
                             P_ArgToChange(arg2), crushDoom);
}
...
{
    return EV_DoZDoomCeiling(DCeiling::ceilRaiseByTexture, ln, arg0, P_ArgToSpeed(arg1), 0, 0, NO_CRUSH,
                             P_ArgToChange(arg2), 0, crushDoom);
}

FUNC(LS_Ceiling_LowerToLowest)
// Ceiling_LowerToLowest (tag, speed)
{
    return EV_DoZDoomCeiling(DCeiling::ceilLowerToLowest, ln, arg0, P_ArgToSpeed(arg1), 0, 0, NO_CRUSH, 0, 0,
                             crushDoom);
}
...
{
    return EV_DoZDoomCeiling(DCeiling::ceilLowerToHighest, ln, arg0, 2 * FRACUNIT, 0, 0, P_ArgToCrush(arg2), 0,
...
{
    return EV_DoZDoomCeiling(DCeiling::ceilLowerToHighest, ln, arg0, 2 * FRACUNIT, 0, arg3, P_ArgToCrush(arg2), 0,
                             P_ArgToChange(arg1), crushDoom);
}
...
{
    return EV_DoZDoomCeiling(DCeiling::ceilLowerToNearest, ln, arg0, P_ArgToSpeed(arg1), 0, 0, P_ArgToCrush(arg3), 0,
                             P_ArgToChange(arg2), crushDoom);
}
...
{
    return EV_DoZDoomCeiling(DCeiling::ceilLowerToFloor, ln, arg0, P_ArgToSpeed(arg1), 0, NO_CRUSH, 0, 0, 0, crushDoom);
}

FUNC(LS_Ceiling_LowerByTexture)
// Ceiling_LowerByTexture (tag, speed, change, crush)
{
    return EV_DoZDoomCeiling(DCeiling::ceilLowerByTexture, ln, arg0, P_ArgToSpeed(arg1), 0, 0, P_ArgToCrush(arg3), 0,
...
// Generic_Ceiling (tag, speed, height, target, change/model/direct/crush)
{
    ...
    if (arg4 & 8)
    {
        ...
        {
        case 1:
            type = DCeiling::ceilRaiseToHighest;
            break;
        case 2:
            type = DCeiling::ceilRaiseToLowest;
            break;
        case 3:
            type = DCeiling::ceilRaiseToNearest;
            break;
        case 4:
            type = DCeiling::ceilRaiseToHighestFloor;
            break;
        case 5:
            type = DCeiling::ceilRaiseToFloor;
            break;
        case 6:
            type = DCeiling::ceilRaiseByTexture;
            break;
        default:
            type = DCeiling::ceilRaiseByValue;
            break;
        }
    }
    else
    {
        ...
        case 1:
            ...
            break;
        case 2:
            type = DCeiling::ceilLowerToLowest;
            break;
        case 3:
            type = DCeiling::ceilLowerToNearest;
            break;
        case 4:
            type = DCeiling::ceilLowerToHighestFloor;
            break;
        case 5:
            type = DCeiling::ceilLowerToFloor;
            break;
        case 6:
            type = DCeiling::ceilLowerByTexture;
            break;
        default:
            type = DCeiling::ceilLowerByValue;
            break;
        }
    }

    return EV_DoZDoomCeiling(type, ln, arg0, P_ArgToSpeed(arg1), P_ArgToSpeed(arg1), arg2, (arg4 & 16) ? 20 : NO_CRUSH,
                             0, arg4 & 7, crushDoom);
}
...
{
    return EV_DoZDoomCeiling(DCeiling::ceilCrushAndRaise, ln, arg0, P_ArgToSpeed(arg1), P_ArgToSpeed(arg2), 0, arg4,
                             arg3 ? 2 : 0, 0, (arg1 <= 24 && arg2 <= 24) ? crushSlowdown : crushDoom);
}
...
// Scroll_Wall (lineid, x, y, side, flags)
{
    if (arg4)
    {
        Printf(PRINT_HIGH, "Warning: Odamex can only scroll entire sidedefs (special 52)");
    }
    if (arg0)
    {
        int s;
...
// Line_SetTextureOffset (lineid, x, y, side, flags)
{
    if (arg4 & 7)
    {
        Printf(PRINT_HIGH, "Warning: Odamex can only offset entire sidedefs (special 53)");
    }
    if (arg0 && arg3 <= 1)
    {
        int s;
...
{
    return P_Thing_Projectile(arg0, arg1, BYTEANGLE(arg2), arg3 << (FRACBITS - 3), arg4 << (FRACBITS - 3), false);
}

FUNC(LS_Thing_ProjectileGravity)
// Thing_ProjectileGravity (tid, type, angle, speed, vspeed)
{
    return P_Thing_Projectile(arg0, arg1, BYTEANGLE(arg2), arg3 << (FRACBITS - 3), arg4 << (FRACBITS - 3), true);
}
...
{
    return EV_DoZDoomElevator(ln, DElevator::elevateLower, P_ArgToSpeed(arg1), arg2, arg0);
}

FUNC(LS_FloorAndCeiling_RaiseByValue)
// FloorAndCeiling_RaiseByValue (tag, speed, height)
{
    return EV_DoZDoomElevator(ln, DElevator::elevateRaise, P_ArgToSpeed(arg1), arg2, arg0);
}
...
// FloorAndCeiling_LowerRaise (tag, fspeed, cspeed, boomemu)
{
    if (arg3 == 1998)
    {
        return EV_DoZDoomCeiling(DCeiling::ceilRaiseToHighest, ln, arg0, P_ArgToSpeed(arg2), 0, 0, 0, 0, 0,
                                 crushDoom) ||
               EV_DoZDoomFloor(DFloor::floorLowerToLowest, ln, arg0, arg1, 0, NO_CRUSH, 0, false, crushDoom);
    }
    else
    {
        return EV_DoZDoomCeiling(DCeiling::ceilRaiseToHighest, ln, arg0, P_ArgToSpeed(arg2), 0, 0, 0, 0, 0,
...
// Sector_SetColor (tag, r, g, b)
{
    ...
    while ((secnum = P_FindSectorFromTag(arg0, secnum)) >= 0)
    {
        sectors[secnum].colormap =
            GetSpecialLights(arg1, arg2, arg3, sectors[secnum].colormap->fade.getr(),
                             sectors[secnum].colormap->fade.getg(), sectors[secnum].colormap->fade.getb());
...
bool CheckIfExitIsGood(AActor *self)
{
    ...
    if (self->player && multiplayer)
    {
        ...
        if (tspan.hours)
        {
            StrFormat(tstr, "%02d:%02d:%02d.%02d", tspan.hours, tspan.minutes, tspan.seconds, tspan.csecs);
        }
        else
        {
...
VERSION_CONTROL(p_lnspec_cpp, "$Id: 6d848d57dd7a275422a95b1c35cc2b1bf502a8d9 $")
