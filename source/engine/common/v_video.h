...
class DCanvas : DObject
{
  ...
  public:
    ...
    DCanvas(IWindowSurface *surface) : mSurface(surface)
    {
    }
  ...
  protected:
    ...
    void TextSWrapper(EWrapperCode drawer, int normalcolor, int x, int y, const byte *string, int scalex,
                      int scaley) const;
...
inline void DCanvas::DrawTextStretchedLuc(int normalcolor, int x, int y, const byte *string, int scalex,
                                          int scaley) const
{
...
inline void DCanvas::DrawTextStretchedLuc(int normalcolor, int x, int y, const char *string, int scalex,
                                          int scaley) const
{
