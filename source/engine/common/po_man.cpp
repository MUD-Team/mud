...
DRotatePoly::DRotatePoly(int polyNum) : Super(polyNum)
{
}
...
DMovePoly::DMovePoly(int polyNum) : Super(polyNum)
{
    m_Angle  = 0;
    m_xSpeed = 0;
    m_ySpeed = 0;
...
DPolyDoor::DPolyDoor(int polyNum, podoortype_t type) : Super(polyNum)
{
    m_Type      = type;
    m_Direction = 0;
    m_TotalDist = 0;
