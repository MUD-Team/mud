...
//-----------------------------------------------------------------------------
//
// $Id: 32d1d535af9433d3cb9a1b5302e31ea6e46ed884 $
//
                                               ...
                                               huff_sym_t *sym)
{
    ...
    for (k = 0; k < insize; ++k)
    {
        if (stream.BytePtr + 17 >=
            out_end) // denis - todo - security, 17 masks potential terminator overflow, should really be a 1
            return false;
...
VERSION_CONTROL(huffman_cpp, "$Id: 32d1d535af9433d3cb9a1b5302e31ea6e46ed884 $")
