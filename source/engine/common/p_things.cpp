...
//-----------------------------------------------------------------------------
//
// $Id: 7db28291415ca8398d93a706fa04e518cfffda51 $
//
    ...
    while ((spot = AActor::FindByTID(spot, tid)))
    {
        ...
        if (mobj)
        {
            if (P_TestMobjLocation(mobj))
            {
                ...
                mobj->angle = angle;
                if (fog)
                    S_Sound(new AActor(spot->x, spot->y, spot->z, MT_TFOG), CHAN_VOICE, "misc/teleport", 1, ATTN_NORM);
...
VERSION_CONTROL(p_things_cpp, "$Id: 7db28291415ca8398d93a706fa04e518cfffda51 $")
