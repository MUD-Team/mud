...
//-----------------------------------------------------------------------------
//
// $Id: 264801a5e02e01a1865156aa0e971ed2c781eb54 $
//
...
bool P_IsTeleportLine(const int16_t special)
{
    ...
    return special == 39 || special == 97 || special == 125 || special == 126 || special == 174 || special == 195 ||
           special == 207 || special == 208 || special == 209 || special == 210 || special == 244 || special == 268 ||
           special == 269;
}
