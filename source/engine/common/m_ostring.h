...
//-----------------------------------------------------------------------------
//
// $Id: ae5dccabf8212cda2c298f3181bd590ed55a0b1d $
//
...
class OString
{
  public:
    ...
    template <class InputIterator> OString(InputIterator first, InputIterator last);
    ...
    template <typename InputIterator> OString &assign(InputIterator first, InputIterator last)
    {
