...
void STACK_ARGS M_SaveDefaults()
{
    ...
    if ((f = PHYSFS_openWrite("odamex.cfg")))
    {
        std::string str = "// Generated by Odamex " DOTVERSIONSTR " - don't hurt anything\n\n";
        ...
        Printf(PRINT_HIGH, "Configuration saved to odamex.cfg.\n");
    }
}
