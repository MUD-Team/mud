...
//-----------------------------------------------------------------------------
//
// $Id: e93d4d5fa73f119bef23e43de44028ee6119ae44 $
//
...
static CVAR(configver, CONFIGVERSIONSTR, "", CVARTYPE_STRING, CVAR_ARCHIVE | CVAR_NOENABLEDISABLE)
    ...
    EXTERN_CVAR(cl_name) EXTERN_CVAR(sv_maxplayers)
...
void STACK_ARGS M_SaveDefaults()
{
    ...
    if ((f = PHYSFS_openWrite("mud-client.cfg")))
    {
        std::string str = "// Generated by MUD " DOTVERSIONSTR " - don't hurt anything\n\n";
        ...
        Printf(PRINT_HIGH, "Configuration saved to mud-client.cfg.\n");
    }
}
...
void M_LoadDefaults(void)
{
    ...
    std::string cmd = "exec " + C_QuoteString("mud-client.cfg");
    ...
    if (::configver <= 90)
    {
        ...
        const char *cl_download_old = "https://static.allfearthesentinel.net/wads/ https://doomshack.org/wads/ "
...
VERSION_CONTROL(m_misc_cpp, "$Id: e93d4d5fa73f119bef23e43de44028ee6119ae44 $")
