...
//-----------------------------------------------------------------------------
//
// $Id: 1f7c41fbda0ea9bc8897dd2938542c86ad142468 $
//
...
void calculateOrigin(int &x, int &y, const unsigned short w, const unsigned short h, const float scale, int &x_scale,
                     int &y_scale, const x_align_t x_align, const y_align_t y_align, const x_align_t x_origin,
                     const y_align_t y_origin)
{
...
void DrawPatch(int x, int y, const float scale, const x_align_t x_align, const y_align_t y_align,
               const x_align_t x_origin, const y_align_t y_origin, const patch_t *patch, const bool force_opaque,
...
void DrawPatchStretched(int x, int y, const unsigned short w, const unsigned short h, const float scale,
                        ...
                        const y_align_t y_origin, const patch_t *patch, const bool force_opaque,
                        const bool use_patch_offsets)
{
    if (patch == NULL)
        return;
                     ...
                     const bool use_patch_offsets)
{
    ...
    DrawPatchStretched(x, y, w, h, scale, x_align, y_align, x_origin, y_origin, patch, force_opaque, use_patch_offsets);
}
