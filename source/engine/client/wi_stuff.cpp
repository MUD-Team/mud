...
//-----------------------------------------------------------------------------
//
// $Id: 17685d803a3530fdd8d001f2c1d3f40102d8db4e $
//
...
//
static animinfo_t epsd0animinfo[] = {{ANIM_ALWAYS, TICRATE / 3, 3, {224, 104}, 0, 0, {NULL, NULL, NULL}, 0, 0, 0, 0},
...
static animinfo_t epsd1animinfo[] = {{ANIM_LEVEL, TICRATE / 3, 1, {128, 136}, 1, 0, {NULL, NULL, NULL}, 0, 0, 0, 0},
...
static animinfo_t epsd2animinfo[] = {{ANIM_ALWAYS, TICRATE / 3, 3, {104, 168}, 0, 0, {NULL, NULL, NULL}, 0, 0, 0, 0},
...
static char names[NUMEPISODES][NUMMAPS][8] = {{"E1M1", "E1M2", "E1M3", "E1M4", "E1M5", "E1M6", "E1M7", "E1M8", "E1M9"},
    ...
    for (int i = 0; i < NUMANIMS[wbs->epsd]; i++)
    {
        ...
        if (bcnt == a->nexttic)
        {
            ...
            case ANIM_LEVEL:
                ...
                if (!(state == StatCount && i == 7) && (WI_MapToIndex(wbs->next) + 1) == a->data1)
                {
                    a->ctr++;
                    if (a->ctr == a->nanims)
                        a->ctr--;
...
VERSION_CONTROL(wi_stuff_cpp, "$Id: 17685d803a3530fdd8d001f2c1d3f40102d8db4e $")
