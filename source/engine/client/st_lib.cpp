...
//-----------------------------------------------------------------------------
//
// $Id: 7a07cf26d7a498fe564626ce1d40c6e2188f9cca $
//
...
void StatusBarWidgetNumber::init(int x_, int y_, lumpHandle_t *pl, int *num_, int maxdigits_)
{
    m_x       = x_;
    m_y       = y_;
    oldnum    = 0;
...
void StatusBarWidgetPercent::init(int x, int y, lumpHandle_t *pl, int *num, lumpHandle_t percent_patch)
{
...
VERSION_CONTROL(st_lib_cpp, "$Id: 7a07cf26d7a498fe564626ce1d40c6e2188f9cca $")
