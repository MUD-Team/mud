...
//-----------------------------------------------------------------------------
//
// $Id: ae5954a1d52710c639583f4513dcbeec718a65d0 $
//
...
void F_StartFinale(finale_options_t &options)
{
    ...
    else
    {
        ...
        S_ChangeMusic(::currentmusic, !(::gameinfo.flags & GI_NOLOOPFINALEMUSIC));
    }
...
castinfo_t castorder[] = {{NULL, MT_POSSESSED},   {NULL, MT_SHOTGUY}, {NULL, MT_CHAINGUY}, {NULL, MT_TROOP},
                          {NULL, MT_SERGEANT},    {NULL, MT_SKULL},   {NULL, MT_HEAD},     {NULL, MT_KNIGHT},
                          {NULL, MT_BRUISER},     {NULL, MT_BABY},    {NULL, MT_PAIN},     {NULL, MT_UNDEAD},
                          {NULL, MT_FATSO},       {NULL, MT_VILE},    {NULL, MT_SPIDER},   {NULL, MT_CYBORG},
                          {NULL, MT_PLAYER},
...
void F_CastDrawer()
{
    ...
    screen->DrawTextClean(CR_RED, x + (width - CleanXfac * V_StringWidth(castorder[castnum].name)) / 2,
                          y + (height * 180 / 200), castorder[castnum].name);
}
...
VERSION_CONTROL(f_finale_cpp, "$Id: ae5954a1d52710c639583f4513dcbeec718a65d0 $")
