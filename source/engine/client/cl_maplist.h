...
//-----------------------------------------------------------------------------
//
// $Id: a7d4d19ae65527cb0b8d35325bbb2908c704bb0b $
//
...
class MaplistCache
{
  ...
  public:
    ...
    // Queries
    void defer_query(query_callback_t query_callback, query_errback_t query_errback);
    void defer_query(const std::vector<std::string> &query, query_callback_t query_callback,
